...
<!-- sidenav -->
	<nav class="pr-side-nav w3-sidenav w3-collapse w3-white w3-animate-left" id="pr-left-nav">
		...
		<a href="equipmentlist.php" class="pr-menu-item w3-padding" ><i class="fa fa-list"></i> List of Equipment</a>
		<a href="plan.php" class="pr-menu-item w3-padding"><i class="fa fa-flag"></i> Daily Plan</a>
		<a href="#" class="pr-menu-item w3-padding"><i class="fa fa-book"></i> Analytical Report</a>
		<a href="#" class="pr-menu-item w3-padding"> Work Order</a>
